...
export default function ChoosingGame() {
      ...
      const interval = setInterval(async () => {
        if (count === 0) {
          ...
          if (userAnswer === questions[currentQuestionIndex].correct_object) {
            setInfoHand("Correct! You are smarter than Einstein...");
          ...
          setInfoHand("The question is answered...");
          setVariant("info");
          setTimer(count);
          count--;
  ...
  useEffect(() => {
    if (currentQuestionIndex === questions.length) {
      if (coldStart) {
        setIsGameOver(true);
        setInfoHand("Game over! You are being redirected to the homepage...");
        setVariant("info");
        try {
    ...
    <div>
      <Container>
        ...
        <Row className="d-flex justify-content-center">
          <Col md={12}>
            <h1 className="text-center">Selection game</h1>
            <hr></hr>
          </Col>
          ...
          <Col md={10}>
            ...
            questions[currentQuestionIndex] !== undefined ? (
              ...
              <div>
                ...
                <Alert variant="light">
                  <Alert.Heading className="text-center">
                  There are currently no questions for this game.
                  </Alert.Heading>
                </Alert>
              </div>
            ) : (
